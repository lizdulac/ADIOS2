...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, std::stack<adios2::detail::ASTNode*>* expr_stack)
#else
static void
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, std::stack<adios2::detail::ASTNode*>* expr_stack)
#else
static void
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, std::stack<adios2::detail::ASTNode*>* expr_stack)
#else
static void
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, std::stack<adios2::detail::ASTNode*>* expr_stack)
#else
static void
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (std::stack<adios2::detail::ASTNode*>* expr_stack)
#else
int
yyparse (expr_stack)
    std::stack<adios2::detail::ASTNode*>* expr_stack;
...
#line 57 "parser.y"
  ...
  case 7:
#line 58 "parser.y"
    { adios2::detail::ASTNode::add_lookup_entry((yyvsp[(1) - (3)].sval), (yyvsp[(2) - (3)].sval), (yyvsp[(3) - (3)].sval)); ;}
    break;
